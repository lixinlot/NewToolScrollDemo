...
///标题背景颜色
@property (nonatomic, strong) IBInspectable UIColor *titleBjColor;
///选项背景颜色
@property (nonatomic, strong) IBInspectable UIColor *subTitleBjColor;
///选项字体颜色
@property (nonatomic, strong) IBInspectable UIColor *subTitleTextColor;
///选项字体大小
@property (nonatomic, assign) IBInspectable CGFloat subTitleFont;
