...
- (void)setUI {
    ...
    self.titleBjColor = [UIColor greenColor];
    self.subTitleBjColor = [UIColor redColor];
    self.subTitleTextColor = [UIColor yellowColor];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.textColor = self.subTitleTextColor;
    cell.backgroundColor = self.subTitleBjColor;
    cell.textLabel.font = [UIFont systemFontOfSize:self.subTitleFont];
    return cell;
}
...
- (UIImageView *)rightImageView {
    if(!_rightImageView) {
        ...
        _rightImageView.frame = CGRectMake(self.frame.size.width-10-10, (self.frame.size.height-10)/2, 10, 10);
...
///标题背景颜色
- (void)setTitleBjColor:(UIColor *)titleBjColor {
    _titleBjColor = titleBjColor;
    self.backgroundColor = titleBjColor;
}
///选项字体大小
...
///选项背景颜色
- (void)setSubTitleBjColor:(UIColor *)subTitleBjColor {
    _subTitleBjColor = subTitleBjColor;
}
///选项字体颜色
