...
- (UITextField *)searchTextField {
    if (!_searchTextField) {
        ...
        _searchTextField.frame = CGRectMake(10, 0, self.width-20-10-10, self.height);
...
- (UIImageView *)rightImageView {
    if(!_rightImageView) {
        ...
        _rightImageView.frame = CGRectMake(self.frame.size.width-10-10, (self.height-15)/2, 10, 15);
